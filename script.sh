...
echo "#                                                                    #"
echo "#              (Opensource Script by BashMail)                       #"
...
echo ""
echo ""
echo "========== Please provide your Domain / Website URL you would like to host, Example: google.com =========="
read domain
sleep 1
echo ""
...
echo "#                                                                                                            #"
echo "#      Please ignore the Self-Signed SSL Error, you can use your Server Root Password for login to WHM       #"
echo "#                                                                                                            #"
echo "#                                                                                                            #"
